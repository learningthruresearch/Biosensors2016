...
plt.xlabel('Concentration of propylene glycol [%]') #name of x axis
plt.ylabel('Humidity [%]') #name of y axis
plt.title('Humidity in function of the propylene glycol concentration') #title of the graph
...
plt.plot(x,y, color='r') #draw th graph
